function _typeof(t) {
    ...
    "function" == typeof define && define.amd ? define([], e(t)) : "object" == ("undefined" == typeof exports ? "undefined" : _typeof(exports)) ? module.exports = e(t) : t.iziToast = e(t)
    ...
    var p = function(t, e, o) {
        ...
        f = {
            move: function(t, e, n, a) {
                var r, l = .3,
                    d = 180;
                0 !== a && (t.classList.add(o + "-dragged"), t.style.transform = "translateX(" + a + "px)", a > 0 ? l > (r = (d - a) / d) && e.hide(m(n, {
                    transitionOut: "fadeOutRight",
                    transitionOutMobile: "fadeOutRight"
                }), t, "drag") : l > (r = (d + a) / d) && e.hide(m(n, {
    ...
    return e.setSetting = function(t, o, n) {
            ...
            function() {
                ...
                if (null !== t) {
                    var e = t.getAttribute("data-iziToast-ref"),
                        n = (e = e.split(",")).indexOf(String(a.ref)); - 1 !== n && e.splice(n, 1), t.setAttribute("data-iziToast-ref", e.join()), 0 === e.length && (t.classList.remove("fadeIn"), t.classList.add("fadeOut"), setTimeout((function() {
                        t.remove()
                    }), 700))
                }
            }(), a.transitionIn && e.classList.remove(a.transitionIn), a.transitionInMobile && e.classList.remove(a.transitionInMobile), n || window.innerWidth <= l ? a.transitionOutMobile && e.classList.add(a.transitionOutMobile) : a.transitionOut && e.classList.add(a.transitionOut);
        var r = e.parentNode.offsetHeight;
        e.parentNode.style.height = r + "px", e.style.pointerEvents = "none", (!n || window.innerWidth > l) && (e.parentNode.style.transitionDelay = "0.2s");
        try {
        ...
        y.toast.setAttribute("data-iziToast-ref", s.ref), y.toast.appendChild(y.toastBody), y.toastCapsule.appendChild(y.toast),
            function() {
                if (y.toast.classList.add(o), y.toast.classList.add(o + "-opening"), y.toastCapsule.classList.add(o + "-capsule"), y.toastBody.classList.add(o + "-body"), y.toastTexts.classList.add(o + "-texts"), n || window.innerWidth <= l ? s.transitionInMobile && y.toast.classList.add(s.transitionInMobile) : s.transitionIn && y.toast.classList.add(s.transitionIn), s.class) {
                    var t = s.class.split(" ");
                    p(t, (function(t, e) {
                        y.toast.classList.add(t)
                    }))
                }
                s.id && (y.toast.id = s.id), s.rtl && (y.toast.classList.add(o + "-rtl"), y.toast.setAttribute("dir", "rtl")), s.layout > 1 && y.toast.classList.add(o + "-layout" + s.layout), s.balloon && y.toast.classList.add(o + "-balloon"), s.maxWidth && (isNaN(s.maxWidth) ? y.toast.style.maxWidth = s.maxWidth : y.toast.style.maxWidth = s.maxWidth + "px"), "" === s.theme && "light" === s.theme || y.toast.classList.add(o + "-theme-" + s.theme), s.color && (function(t) {
                    return "#" == t.substring(0, 1) || "rgb" == t.substring(0, 3) || "hsl" == t.substring(0, 3)
                }(s.color) ? y.toast.style.background = s.color : y.toast.classList.add(o + "-color-" + s.color)), s.backgroundColor && (y.toast.style.background = s.backgroundColor, s.balloon && (y.toast.style.borderColor = s.backgroundColor))
            }(), s.image && (y.cover.classList.add(o + "-cover"), y.cover.style.width = s.imageWidth + "px", function(t) {
                try {
                    return btoa(atob(t)) == t
                } catch (t) {
                    return !1
                }
            }(s.image.replace(/ /g, "")) ? y.cover.style.backgroundImage = "url(data:image/png;base64," + s.image.replace(/ /g, "") + ")" : y.cover.style.backgroundImage = "url(" + s.image + ")", s.rtl ? y.toastBody.style.marginRight = s.imageWidth + 10 + "px" : y.toastBody.style.marginLeft = s.imageWidth + 10 + "px", y.toast.appendChild(y.cover)), s.close ? (y.buttonClose = document.createElement("button"), y.buttonClose.type = "button", y.buttonClose.classList.add(o + "-close"), y.buttonClose.addEventListener("click", (function(t) {
                t.target, i.hide(s, y.toast, "button")
            })), y.toast.appendChild(y.buttonClose)) : s.rtl ? y.toast.style.paddingLeft = "18px" : y.toast.style.paddingRight = "18px", s.progressBar && (y.progressBar = document.createElement("div"), y.progressBarDiv = document.createElement("div"), y.progressBar.classList.add(o + "-progressbar"), y.progressBarDiv.style.background = s.progressBarColor, y.progressBar.appendChild(y.progressBarDiv), y.toast.appendChild(y.progressBar)), s.timeout && (s.pauseOnHover && !s.resetOnHover && (y.toast.addEventListener("mouseenter", (function(t) {
                i.progress(s, y.toast).pause()
            })), y.toast.addEventListener("mouseleave", (function(t) {
                i.progress(s, y.toast).resume()
            }))), s.resetOnHover && (y.toast.addEventListener("mouseenter", (function(t) {
                i.progress(s, y.toast).reset()
            })), y.toast.addEventListener("mouseleave", (function(t) {
                i.progress(s, y.toast).start()
            })))), s.iconUrl ? (y.icon.setAttribute("class", o + "-icon"), y.icon.setAttribute("src", s.iconUrl)) : s.icon && (y.icon.setAttribute("class", o + "-icon " + s.icon), s.iconText && y.icon.appendChild(document.createTextNode(s.iconText)), s.iconColor && (y.icon.style.color = s.iconColor)), (s.icon || s.iconUrl) && (s.rtl ? y.toastBody.style.paddingRight = "33px" : y.toastBody.style.paddingLeft = "33px", y.toastBody.appendChild(y.icon)), s.title.length > 0 && (y.strong = document.createElement("strong"), y.strong.classList.add(o + "-title"), y.strong.appendChild(g(s.title)), y.toastTexts.appendChild(y.strong), s.titleColor && (y.strong.style.color = s.titleColor), s.titleSize && (isNaN(s.titleSize) ? y.strong.style.fontSize = s.titleSize : y.strong.style.fontSize = s.titleSize + "px"), s.titleLineHeight && (isNaN(s.titleSize) ? y.strong.style.lineHeight = s.titleLineHeight : y.strong.style.lineHeight = s.titleLineHeight + "px")), s.message.length > 0 && (y.p = document.createElement("p"), y.p.classList.add(o + "-message"), y.p.appendChild(g(s.message)), y.toastTexts.appendChild(y.p), s.messageColor && (y.p.style.color = s.messageColor), s.messageSize && (isNaN(s.titleSize) ? y.p.style.fontSize = s.messageSize : y.p.style.fontSize = s.messageSize + "px"), s.messageLineHeight && (isNaN(s.titleSize) ? y.p.style.lineHeight = s.messageLineHeight : y.p.style.lineHeight = s.messageLineHeight + "px")), s.title.length > 0 && s.message.length > 0 && (s.rtl ? y.strong.style.marginLeft = "10px" : 2 === s.layout || s.rtl || (y.strong.style.marginRight = "10px")), y.toastBody.appendChild(y.toastTexts), s.inputs.length > 0 && (y.inputs.classList.add(o + "-inputs"), p(s.inputs, (function(t, e) {
                y.inputs.appendChild(g(t[0])), (u = y.inputs.childNodes)[e].classList.add(o + "-inputs-child"), t[3] && setTimeout((function() {
                    u[e].focus()
                }), 300), u[e].addEventListener(t[1], (function(e) {
                    return (0, t[2])(i, y.toast, this, e)
                }))
            })), y.toastBody.appendChild(y.inputs)), s.buttons.length > 0 && (y.buttons.classList.add(o + "-buttons"), p(s.buttons, (function(t, e) {
                y.buttons.appendChild(g(t[0]));
                var n = y.buttons.childNodes;
                n[e].classList.add(o + "-buttons-child"), t[2] && setTimeout((function() {
                    n[e].focus()
                }), 300), n[e].addEventListener("click", (function(e) {
                    return e.preventDefault(), (0, t[1])(i, y.toast, this, e, u)
                }))
            }))), y.toastBody.appendChild(y.buttons), s.message.length > 0 && (s.inputs.length > 0 || s.buttons.length > 0) && (y.p.style.marginBottom = "0"), (s.inputs.length > 0 || s.buttons.length > 0) && (s.rtl ? y.toastTexts.style.marginLeft = "10px" : y.toastTexts.style.marginRight = "10px", s.inputs.length > 0 && s.buttons.length > 0 && (s.rtl ? y.inputs.style.marginLeft = "8px" : y.inputs.style.marginRight = "8px")), y.toastCapsule.style.visibility = "hidden", setTimeout((function() {
                var t = y.toast.offsetHeight,
                    e = y.toast.currentStyle || window.getComputedStyle(y.toast),
                    o = e.marginTop;
                o = o.split("px"), o = parseInt(o[0]);
                var n = e.marginBottom;
                n = n.split("px"), n = parseInt(n[0]), y.toastCapsule.style.visibility = "", y.toastCapsule.style.height = t + n + o + "px", setTimeout((function() {
                    y.toastCapsule.style.height = "auto", s.target && (y.toastCapsule.style.overflow = "visible")
                }), 500), s.timeout && i.progress(s, y.toast).start()
            }), 100),
            function() {
                var t = s.position;
                if (s.target) y.wrapper = document.querySelector(s.target), y.wrapper.classList.add(o + "-target"), s.targetFirst ? y.wrapper.insertBefore(y.toastCapsule, y.wrapper.firstChild) : y.wrapper.appendChild(y.toastCapsule);
                else {
                    if (-1 == r.indexOf(s.position)) return void console.warn("[" + o + "] Incorrect position.\nIt can be › " + r);
                    t = n || window.innerWidth <= l ? "bottomLeft" == s.position || "bottomRight" == s.position || "bottomCenter" == s.position ? o + "-wrapper-bottomCenter" : "topLeft" == s.position || "topRight" == s.position || "topCenter" == s.position ? o + "-wrapper-topCenter" : o + "-wrapper-center" : o + "-wrapper-" + t, y.wrapper = document.querySelector("." + o + "-wrapper." + t), y.wrapper || (y.wrapper = document.createElement("div"), y.wrapper.classList.add(o + "-wrapper"), y.wrapper.classList.add(t), document.body.appendChild(y.wrapper)), "topLeft" == s.position || "topCenter" == s.position || "topRight" == s.position ? y.wrapper.insertBefore(y.toastCapsule, y.wrapper.firstChild) : y.wrapper.appendChild(y.toastCapsule)
                }
                isNaN(s.zindex) ? console.warn("[" + o + "] Invalid zIndex.") : y.wrapper.style.zIndex = s.zindex
            }(), s.overlay && (null !== document.querySelector("." + o + "-overlay.fadeIn") ? (y.overlay = document.querySelector("." + o + "-overlay"), y.overlay.setAttribute("data-iziToast-ref", y.overlay.getAttribute("data-iziToast-ref") + "," + s.ref), isNaN(s.zindex) || null === s.zindex || (y.overlay.style.zIndex = s.zindex - 1)) : (y.overlay.classList.add(o + "-overlay"), y.overlay.classList.add("fadeIn"), y.overlay.style.background = s.overlayColor, y.overlay.setAttribute("data-iziToast-ref", s.ref), isNaN(s.zindex) || null === s.zindex || (y.overlay.style.zIndex = s.zindex - 1), document.querySelector("body").appendChild(y.overlay)), s.overlayClose ? (y.overlay.removeEventListener("click", {}), y.overlay.addEventListener("click", (function(t) {
                i.hide(s, y.toast, "overlay")
            }))) : y.overlay.removeEventListener("click", {})),
            function() {
                if (s.animateInside) {
                    y.toast.classList.add(o + "-animateInside");
                    var t = [200, 100, 300];
                    "bounceInLeft" != s.transitionIn && "bounceInRight" != s.transitionIn || (t = [400, 200, 400]), s.title.length > 0 && setTimeout((function() {
                        y.strong.classList.add("slideIn")
                    }), t[0]), s.message.length > 0 && setTimeout((function() {
                        y.p.classList.add("slideIn")
                    }), t[1]), (s.icon || s.iconUrl) && setTimeout((function() {
                        y.icon.classList.add("revealIn")
                    }), t[2]);
                    var e = 150;
                    s.buttons.length > 0 && y.buttons && setTimeout((function() {
                        p(y.buttons.childNodes, (function(t, o) {
                            setTimeout((function() {
                                t.classList.add("revealIn")
                            }), e), e += 150
                        }))
                    }), s.inputs.length > 0 ? 150 : 0), s.inputs.length > 0 && y.inputs && (e = 150, p(y.inputs.childNodes, (function(t, o) {
                        setTimeout((function() {
                            t.classList.add("revealIn")
                        }), e), e += 150
                    })))
                }
            }(), s.onOpening.apply(null, [s, y.toast]);
        try {
            var v = new CustomEvent(o + "-opening", {
                detail: s,
                bubbles: !0,
                cancelable: !0
            });
        ...
        setTimeout((function() {
            y.toast.classList.remove(o + "-opening"), y.toast.classList.add(o + "-opened");
            try {
            ...
            s.onOpened.apply(null, [s, y.toast])
        }), 1e3), s.drag && (a ? (y.toast.addEventListener("touchstart", (function(t) {
            f.startMoving(this, i, s, t)
        }), !1), y.toast.addEventListener("touchend", (function(t) {
            f.stopMoving(this, t)
        }), !1)) : (y.toast.addEventListener("mousedown", (function(t) {
            t.preventDefault(), f.startMoving(this, i, s, t)
        }), !1), y.toast.addEventListener("mouseup", (function(t) {
            t.preventDefault(), f.stopMoving(this, t)
        }), !1))), s.closeOnEscape && document.addEventListener("keyup", (function(t) {
            27 == (t = t || window.event).keyCode && i.hide(s, y.toast, "esc")
        })), s.closeOnClick && y.toast.addEventListener("click", (function(t) {
            i.hide(s, y.toast, "toast")
        })), i.toast = y.toast
    }, e
}));