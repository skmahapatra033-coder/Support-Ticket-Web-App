function _typeof(e) {
    ...
    w.find = C, (w.expr = C.selectors)[":"] = w.expr.pseudos, w.uniqueSort = w.unique = C.uniqueSort, w.text = C.getText, w.isXMLDoc = C.isXML, w.contains = C.contains, w.escapeSelector = C.escape;
    ...
    w.Callbacks = function(e) {
        var t;
        e = "string" == typeof e ? (t = {}, w.each(e.match(P) || [], (function(e, n) {
            t[n] = !0
        })), t) : w.extend({}, e);
        var n, r, i, o, a = [],
            s = [],
    ...
    var B = function e(t, n, r, i, o, a, s) {
            ...
            else if (void 0 !== i && (o = !0, h(i) || (s = !0), c && (s ? (n.call(t, i), n = null) : (c = n, n = function(e, t, n) {
                    return c.call(w(e), n)
                })), n))
    ...
    w.extend({
        ...
        css: function(e, t, n, r) {
            var i, o, a, s = X(t);
            return Xe.test(t) || (t = ze(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = _e(e, t, r)), "normal" === i && t in Ge && (i = Ge[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
        ...
        if (t) return (parseFloat(_e(e, "marginLeft")) || e.getBoundingClientRect().left - Me(e, {
            marginLeft: 0
        }, (function() {
    ...
    w.extend(w.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !mt.test(m + w.event.triggered) && (-1 < m.indexOf(".") && (m = (x = m.split(".")).shift(), x.sort()), l = m.indexOf(":") < 0 && "on" + m, (t = t[w.expando] ? t : new w.Event(m, "object" == _typeof(t) && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[m] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !g(r)) {
    ...
    Mt.href = bt.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            var r, i, o, a, s, u, l, c, f, p, d = w.ajaxSetup({}, n = n || {}),
                h = d.context || d,
            ...
            if (y.promise(S), d.url = ((t || d.url || bt.href) + "").replace(Ht, bt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(P) || [""], null == d.crossDomain) {
                u = v.createElement("a");
                try {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), _t(Ot, d, n, S), l) return S;
            ...
            if (C = "abort", m.add(d.complete), S.done(d.success), S.fail(d.error), r = _t(Pt, d, n, S)) {
            ...
            function E(t, n, a, u) {
                ...
                }(d, S, a)), !f && -1 < w.inArray("script", d.dataTypes) && w.inArray("json", d.dataTypes) < 0 && (d.converters["text script"] = function() {}), b = function(e, t, n, r) {
                    var i, o, a, s, u, l = {},
                        c = e.dataTypes.slice();
                    if (c[1])
    ...
    w.ajaxSetup({
    ...
    })), d.createHTMLDocument = (($t = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === $t.childNodes.length), w.parseHTML = function(e, t, n) {
        ...
        w.cssHooks[t] = We(d.pixelPosition, (function(e, n) {
            if (n) return n = _e(e, t), Pe.test(n) ? w(e).position()[t] + "px" : n
        }))
    })), w.each({
        Height: "height",
        Width: "width"
