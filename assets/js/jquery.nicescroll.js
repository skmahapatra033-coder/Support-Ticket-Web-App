        ...
        x = function(e, p) {
                ...
                if ((T.isie11 || T.isie10) && (e["-ms-overflow-style"] = "none"), m.ishwscroll && (this.doc.css(T.transitionstyle, T.prefixstyle + "transform 0ms ease-out"), T.transitionend && m.bind(m.doc, T.transitionend, m.onScrollTransitionEnd, !1)), m.zindex = "auto", m.ispage || "auto" != g.zindex ? m.zindex = g.zindex : m.zindex = function() {
                    ...
                    if (m.onmousedown = function(e, o) {
                        ...
                        var L = function e(o) {
                            if (m.selectiondrag) {
                                if (o) {
                                    var t = m.win.outerHeight(),
                                        r = o.pageY - m.selectiondrag.top;
                                    r > 0 && r < t && (r = 0), r >= t && (r -= t), m.selectiondrag.df = r
                                }
                                if (0 !== m.selectiondrag.df) {
                                    var i = -2 * m.selectiondrag.df / 6 | 0;
                                    m.doScrollBy(i), m.debounced("doselectionscroll", (function() {
                                        e()
                                    }), 50)
                                }
                            }
            ...
            if (this.onmousewheel = function(e) {
                ...
                if (m.ishwscroll && T.hastransition && g.usetransition && g.smoothscroll) {
                    ...
                    w();
                    m.scrollrunning || (m.triggerScrollStart(i, r, e, o, l), m.scrollrunning = !0, m.timer = u((function e() {
                        if (m.scrollrunning) {
                            var o = m.bzscroll.y.getPos();
                            m.setScrollLeft(m.bzscroll.x.getNow()), m.setScrollTop(m.bzscroll.y.getNow()), o <= 1 ? m.timer = u(e) : (m.scrollrunning = !1, m.timer = 0, m.triggerScrollEnd())
                        }
                    })))
                }, this.cancelScroll = function() {
        ...
        S = function(e) {
            ...
            this.nc = e, this.lastx = 0, this.lasty = 0, this.speedx = 0, this.speedy = 0, this.lasttime = 0, this.steptime = 0, this.snapx = !1, this.snapy = !1, this.demulx = 0, this.demuly = 0, this.lastscrollx = -1, this.lastscrolly = -1, this.chkx = 0, this.chky = 0, this.timer = 0, this.reset = function(e, t) {
                ...
                if (c || d) {
                    ...
                    ! function e() {
                        var r = w() - t > 600 ? .04 : .02;
                        o.speedx && (p = Math.floor(o.lastscrollx - o.speedx * (1 - o.demulxy)), o.lastscrollx = p, (p < 0 || p > l) && (r = .1)), o.speedy && (m = Math.floor(o.lastscrolly - o.speedy * (1 - o.demulxy)), o.lastscrolly = m, (m < 0 || m > n) && (r = .1)), o.demulxy = Math.min(1, o.demulxy + r), o.nc.synched("domomentum2d", (function() {
                            if (o.speedx) {
                                o.nc.getScrollLeft();
                        ...
                        })), o.demulxy < 1 ? o.timer = setTimeout(e, u) : (o.stop(), o.nc.hideCursor(), o.doSnapy(p, m))
                    }()
