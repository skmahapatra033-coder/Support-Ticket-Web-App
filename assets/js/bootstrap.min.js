function _typeof(t) {
    ...
    "object" == ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? e(exports, require("jquery"), require("popper.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = {}, t.jQuery, t.Popper)
}(this, (function(t, e, n) {
    "use strict";
            ...
            typeCheckConfig: function(t, e, n) {
                for (var i in n)
                    if (Object.prototype.hasOwnProperty.call(n, i)) {
                        var o = n[i],
                            a = e[i],
                            s = a && d.isElement(a) ? "element" : null === (r = a) || void 0 === r ? "" + r : {}.toString.call(r).match(/\s([a-z]+)/i)[1].toLowerCase();
                    ...
                    if (i) {
                        if ("radio" === i.type)
                            if (i.checked && this._element.classList.contains(p)) t = !1;
                                ...
                                a && o.default(a).removeClass(p)
                            }
                        t && ("checkbox" !== i.type && "radio" !== i.type || (i.checked = !this._element.classList.contains(p)), this.shouldAvoidTriggerChange || o.default(i).trigger("change")), i.focus(), e = !1
                    }
                }
                this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(p)), t && o.default(this._element).toggleClass(p))
            }, e.dispose = function() {
    ...
    o.default(document).on("click.bs.button.data-api", v, (function(t) {
        ...
        for (var a = 0, s = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length; a < s; a++) {
            var r = t[a];
            "true" === r.getAttribute("aria-pressed") ? r.classList.add(p) : r.classList.remove(p)
        }
    })), o.default.fn.button = E._jQueryInterface, o.default.fn.button.Constructor = E, o.default.fn.button.noConflict = function() {
        return o.default.fn.button = _, E._jQueryInterface
    };
    var T = "carousel",
        w = "bs.carousel",
        C = o.default.fn[T],
        ...
        P = function() {
            ...
            return e.next = function() {
                ...
                return t = l({}, k, t), d.typeCheckConfig(T, t, O), t
                ...
                var n, i, a, s = this,
                    r = this._element.querySelector(I),
                    l = this._getItemIndex(r),
                    u = e || r && this._getItemByDirection(t, r),
                ...
                if (t === N ? (n = "carousel-item-left", i = "carousel-item-next", a = "left") : (n = "carousel-item-right", i = "carousel-item-prev", a = "right"), u && o.default(u).hasClass(S)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(u, a).isDefaultPrevented() && r && u) {
                    ...
                    if (o.default(this._element).hasClass("slide")) {
                        o.default(u).addClass(i), d.reflow(u), o.default(r).addClass(n), o.default(u).addClass(n);
                        var g = d.getTransitionDurationFromElement(r);
                        o.default(r).one(d.TRANSITION_END, (function() {
                            o.default(u).removeClass(n + " " + i).addClass(S), o.default(r).removeClass("active " + i + " " + n), s._isSliding = !1, setTimeout((function() {
                                return o.default(s._element).trigger(h)
                            }), 0)
                        })).emulateTransitionEnd(g)
                    } else o.default(r).removeClass(S), o.default(u).addClass(S), this._isSliding = !1, o.default(this._element).trigger(h);
                    c && this.cycle()
                }
            }, t._jQueryInterface = function(e) {
                return this.each((function() {
    ...
    var L = "collapse",
        ...
        V = function() {
            ...
            return e.toggle = function() {
                    ...
                    if (o.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        if (i > 0)
                            for (var a = 0; a < i; a++) {
                                ...
                                null !== r && (o.default([].slice.call(document.querySelectorAll(r))).hasClass(q) || o.default(s).addClass(B).attr("aria-expanded", !1))
                            }
                ...
                return (t = l({}, M, t)).toggle = Boolean(t.toggle), d.typeCheckConfig(L, t, W), t
                ...
                return this.each((function() {
                    var n = o.default(this),
                        i = n.data(R),
                        a = l({}, M, n.data(), "object" == _typeof(e) && e ? e : {});
    ...
    var z = "dropdown",
        ...
        rt = function() {
            ...
            return e.toggle = function() {
                ...
                if (void 0 === e && (e = !1), !(this._element.disabled || o.default(this._element).hasClass($) || o.default(this._menu).hasClass(J))) {
                    ...
                    if (o.default(s).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar && e) {
                            ...
                            var r = this._element;
                            "parent" === this._config.reference ? r = s : d.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && o.default(s).addClass("position-static"), this._popper = new a.default(r, this._menu, this._getPopperConfig())
                        }
                ...
                return t = l({}, this.constructor.Default, o.default(this._element).data(), t), d.typeCheckConfig(z, t, this.constructor.DefaultType), t
                    ...
                    for (var n = [].slice.call(document.querySelectorAll(it)), i = 0, a = n.length; i < a; i++) {
                        ...
                        if (e && "click" === e.type && (l.clickEvent = e), r) {
                            ...
                            if (o.default(s).hasClass(J) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && o.default.contains(s, e.target))) {
                                var f = o.default.Event(Z, l);
                                o.default(s).trigger(f), f.isDefaultPrevented() || ("ontouchstart" in document.documentElement && o.default(document.body).children().off("mouseover", null, o.default.noop), n[i].setAttribute("aria-expanded", "false"), r._popper && r._popper.destroy(), o.default(u).removeClass(J), o.default(s).removeClass(J).trigger(o.default.Event(tt, l)))
                            }
                        }
                    }
    ...
    o.default(document).on(nt, it, rt._dataApiKeydownHandler).on(nt, ot, rt._dataApiKeydownHandler).on(et + " keyup.bs.dropdown.data-api", rt._clearMenus).on(et, it, (function(t) {
        t.preventDefault(), t.stopPropagation(), rt._jQueryInterface.call(o.default(this), "toggle")
    })).on(et, ".dropdown form", (function(t) {
        t.stopPropagation()
    })), o.default.fn[z] = rt._jQueryInterface, o.default.fn[z].Constructor = rt, o.default.fn[z].noConflict = function() {
        return o.default.fn[z] = X, rt._jQueryInterface
    };
    var lt = "bs.modal",
            ...
            return e.toggle = function(t) {
                ...
                if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (o.default(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), o.default(document).off(_t), o.default(this._element).removeClass(ct), o.default(this._element).off(vt), o.default(this._dialog).off(bt), i) {
                ...
                })), o.default(document).off(_t), o.default.removeData(this._element, lt), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, e.handleUpdate = function() {
                this._adjustDialog()
            }, e._getConfig = function(t) {
                return t = l({}, Tt, t), d.typeCheckConfig("modal", t, wt), t
                ...
                if (n) {
                    ...
                    o.default(this._dialog).one(d.TRANSITION_END, s).emulateTransitionEnd(r)
                } else s()
            }, e._enforceFocus = function() {
                var t = this;
                o.default(document).off(_t).on(_t, (function(e) {
                ...
                var t = this;
                this._isShown ? o.default(window).on(pt, (function(e) {
                    return t.handleUpdate(e)
                })) : o.default(window).off(pt)
                ...
                return this.each((function() {
                    var i = o.default(this).data(lt),
                        a = l({}, Tt, o.default(this).data(), "object" == _typeof(e) && e ? e : {});
                    if (i || (i = new t(this, a), o.default(this).data(lt, i)), "string" == typeof e) {
                        if (void 0 === i[e]) throw new TypeError('No method named "' + e + '"');
                        i[e](n)
    ...
    o.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', (function(t) {
        ...
        var a = o.default(e).data(lt) ? "toggle" : l({}, o.default(e).data(), o.default(this).data());
        ...
        Wt = function() {
            ...
            return e.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    s.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && o.default(s).addClass(Lt);
    ...
    var Gt = "scrollspy",
        ...
        se = function() {
            ...
            return e.refresh = function() {
                ...
                if ("string" != typeof(t = l({}, oe, "object" == _typeof(t) && t ? t : {})).target && d.isElement(t.target)) {
        ...
        ge = function() {
            ...
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && o.default(this._element).hasClass(ue) || o.default(this._element).hasClass("disabled"))) {
                    ...
                    if (n && o.default(n).trigger(r), o.default(this._element).trigger(l), !l.isDefaultPrevented() && !r.isDefaultPrevented()) {
                ...
                o.default.removeData(this._element, re), this._element = null
                ...
                if (a && s) {
                    ...
                    o.default(a).removeClass(de).one(d.TRANSITION_END, r).emulateTransitionEnd(l)
                } else r()
    ...
    o.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(t) {
        ...
        return o.default.fn.tab = le, ge._jQueryInterface
    };
    var me = "bs.toast",
        ...
        we = function() {
            ...
            return e.show = function() {
                ...
                if (o.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    if (this._element.classList.remove(pe), d.reflow(this._element), this._element.classList.add(ye), this._config.animation) {
                ...
                return t = l({}, Ee, o.default(this._element).data(), "object" == _typeof(t) && t ? t : {}), d.typeCheckConfig("toast", t, this.constructor.DefaultType), t
            }, e._setListeners = function() {
                var t = this;
                ...
                var t = this,
                    e = function() {
                        t._element.classList.add(pe), o.default(t._element).trigger("hidden.bs.toast")
                    };
    ...
    o.default.fn.toast = we._jQueryInterface, o.default.fn.toast.Constructor = we, o.default.fn.toast.noConflict = function() {
        return o.default.fn.toast = _e, we._jQueryInterface
    }, t.Alert = g, t.Button = E, t.Carousel = P, t.Collapse = V, t.Dropdown = rt, t.Modal = Ct, t.Popover = Jt, t.Scrollspy = se, t.Tab = ge, t.Toast = we, t.Tooltip = Wt, t.Util = d, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));