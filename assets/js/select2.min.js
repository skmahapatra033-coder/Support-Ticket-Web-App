    ...
    var t = function() {
            ...
            return t && t.requirejs || (t ? r = t : t = {}, u = {}, d = {}, p = {}, h = {}, f = Object.prototype.hasOwnProperty, g = [].slice, m = /\.js$/, l = function(e, t) {
                var n, r, i = A(e),
                    o = i[0],
                    s = t[1];
                return e = i[1], o && (n = w(o = y(o, s))), o ? e = n && n.normalize ? n.normalize(e, (r = s, function(e) {
                    return y(e, r)
                })) : y(e, s) : (o = (i = A(e = y(e, s)))[0], e = i[1], o && (n = w(o))), {
                    f: o ? o + "!" + e : e,
                    n: e,
                    pr: o,
                    p: n
                ...
                if (g = x(r = r || e), "undefined" == $ || "function" == $) {
                    ...
                    else if (v(u, s) || v(d, s) || v(h, s)) y[f] = w(s);
                    else {
                        if (!p.p) throw new Error(e + " missing " + s);
                        p.p.load(p.n, _(r, !0), b(s), {}), y[f] = u[s]
                    }
                ...
                return e.prototype.bind = function(e, t, n) {
                    ...
                    this.current((function(e) {
                        ...
                        0 < n.maximumSelectionLength && r >= n.maximumSelectionLength ? n.trigger("results:message", {
                ...
                return O.prototype.apply = function(u) {
                    ...
                    for (var L = [], I = 0; I < u.language.length; I++) {
                        var j = u.language[I]; - 1 === L.indexOf(j) && L.push(j)
                    }
                    ...
                    for (var r = [], i = 0; i < n.length; i++)
                        if (r.push(n[i]), "string" == typeof n[i] && 0 < n[i].indexOf("-")) {
                            var o = n[i].split("-")[0];
                            r.push(o)
                        }
                    return r
                ...
                return n.Extend(i, n.Observable), i.prototype._generateId = function(e) {
                    ...
                    if (!t || !t.target || "OPTION" === t.target.nodeName || "OPTGROUP" === t.target.nodeName) {
                        if (n)
                            ...
                            else n.removedNodes && 0 < n.removedNodes.length ? r = !0 : e.isArray(n) && e.each(n, (function(e, t) {
                                if (i._isChangeMutation(e, t)) return !(r = !0)
                            }));
                        else r = !0;
                        return r
                    }
