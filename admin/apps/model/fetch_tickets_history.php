...
$page   = isset($_GET['page']) ? (int)$_GET['page'] : 4;
...
/* ============================================================
   FUNCTION TO BUILD COMMON PARAMS (Avoid duplication)
============================================================ */

function buildParams($searchParam, $statusFilter, $approveFilter, $customerFilter, $agentFilter) {
...
$countParams = buildParams($searchParam, $statusFilter, $approveFilter, $customerFilter, $agentFilter);
...
$dataParams = buildParams($searchParam, $statusFilter, $approveFilter, $customerFilter, $agentFilter);
$dataParams[] = $offset;
$dataParams[] = $limit;
