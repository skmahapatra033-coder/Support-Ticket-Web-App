...
try {
    ...
    if ($name === '' || $email === '' || $phone === '' || $password === '' || $client === '') {
    ...
    /* ===============================
       CHECK DUPLICATE
    ================================ */
    $checkStmt = $con->prepare("SELECT id FROM customers WHERE email = ? OR phone = ?");
    ...
    ================================ */
    $customerStmt = $con->prepare("INSERT INTO customers 
        (client_id, name, email, phone, gender, profile, about, password) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    /* ===============================
       INSERT INTO USERS (WITH CUSTOMER ID)
    ================================ */
    $role   = 'customer';
    $status = 'active';
